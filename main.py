...
# def find_leader_data(df, follower_id, run_index,pos):
...
# def extract_subject_and_leader_data(df, follower_id, run_index, pos):
#     sdf = df[(df['id'] == follower_id) & (df['run_index'] == run_index)].round(2)
#     ldf = find_leader_data(df, follower_id, run_index, pos).round(2)
...
# def simulate_car_following(params, total_time, time_step, sdf, pos, leader_position, leader_speed, follower_id, accl_max, v_desired, Tcorr, RT, target_position, target_speed):
...
# def fitness(params, total_time, time_step, sdf, pos, leader_position, leader_speed, follower_id, accl_max, v_desired, Tcorr, RT, target_position, target_speed):
#     sim_position, sim_speed, acl = simulate_car_following(params, total_time, time_step, sdf, pos, leader_position, leader_speed, follower_id, accl_max, v_desired, Tcorr, RT, target_position, target_speed)
...
# def genetic_algorithm(population_size, num_generations, total_time, time_step, sdf, pos, leader_position, leader_speed, follower_id, accl_max, v_desired, Tcorr, RT, target_position, target_speed):
...
#         fitness_and_errors = [fitness(individual, total_time, time_step, sdf, pos, leader_position, leader_speed, follower_id, accl_max, v_desired, Tcorr, RT, target_position, target_speed) for individual in population]
...
# def plot_simulation(timex, leader_position, target_position, sim_position, leader_speed, target_speed, sim_speed, follower_id, most_leading_leader_id, run_index, save_dir, outname):
...
#     if len(all_params_array.shape) == 1:  # If 1D, wrap it in another list
#         print("Warning: Input array is 1D, reshaping to 2D...")
#         all_params_array = np.expand_dims(all_params_array, axis=0)
    
#     # Debug the shape
#     print("Shape of all_params_array:", all_params_array.shape)
...
#                 sdf, ldf = extract_subject_and_leader_data(df, follower_id, run_index, pos)
#                 print(follower_id)
...
#                     best_params, best_error, best_metrics = genetic_algorithm(population_size, num_generations, total_time, time_step, sdf, pos, leader_position, leader_speed, follower_id, accl_max, v_desired, Tcorr, RT, target_position, target_speed)
#                     all_params.append(best_params)
#                     params_list.append([follower_id, run_index] + best_params + [best_error] + list(best_metrics.values()))
#                     #print (params_list)
#                     sim_position, sim_speed, acl = simulate_car_following(best_params, total_time, time_step, sdf, pos, leader_position, leader_speed, follower_id, accl_max, v_desired, Tcorr, RT, target_position, target_speed) 
                    
#                     plot_simulation(timex, leader_position, target_position, sim_position, leader_speed, target_speed, sim_speed, follower_id, most_leading_leader_id, run_index, save_dir, outname)
